...
export class GithubClient {
  ...
  async getRepository (owner: string, repo: string) {
    const res = await this.client.request(`https://api.github.com/repos/${owner}/${repo}`, {
   ...
   * @returns {Promise<Object[]>}
   */
  async getCommits (options = {}, owner: string, repo: string) {
    const res = await this.client.request(`https://api.github.com/repos/${owner}/${repo}/commits${this.query(options)}`, {
      headers: this.commonHeaders
    })
    return await this.toJson(res)
  }
   ...
   * @returns {Promise<Object>}
   */
  async getCommitBySha (sha: string, owner: string, repo: string) {
    if (!sha) {
      throw new Error('sha cannot be empty')
    }
    const res = await this.client.request(`https://api.github.com/repos/${owner}/${repo}/commits/${sha}`, {
      headers: this.commonHeaders
    })
    return await this.toJson(res)
  }
   ...
   * @returns {Promise<Object[]>}
   */
  async getReleases (options = {}, owner: string, repo: string) {
    const res = await this.client.request(`https://api.github.com/repos/${owner}/${repo}/releases${this.query(options)}`, {
      headers: this.commonHeaders
    })
    return await this.toJson(res)
  }
   ...
   * @returns {Promise<Object[]>}
   */
  async getActionsArtifacts (options = {}, owner: string, repo: string) {
    const res = await this.client.request(`https://api.github.com/repos/${owner}/${repo}/actions/artifacts${this.query(options)}`, {
      headers: this.commonHeaders
    })
    return await this.toJson(res)
  }
   ...
   */
  async getIssues (options = {}, owner: string, repo: string) {
    const res = await this.client.request(`https://api.github.com/repos/${owner}/${repo}/issues${this.query(options)}`, {
      headers: this.commonHeaders
    })
    return await this.toJson(res)
  }
   ...
   */
  async getIssueTimeline (issueNumber: number, owner: string, repo: string) {
    const res = await this.client.request(`https://api.github.com/repos/${owner}/${repo}/issues/${issueNumber}/timeline`, {
      headers: this.commonHeaders
    })
    return await this.toJson(res)
  }
   ...
   * @returns {string}
   */
  query (params: { [x: string]: any }, containsQuestionMark = true) {
